...
namespace SecureWebApiJWT.Helpers
{
    public class TokenHelper
    {
        ...
        //Important note
        //The secret is a base64-encoded string, always make sure to use a secure long string so one can guess it ever !
        // a very common approach to use is through the HMACSHA256() class, to generate such a secret, you can refer to the below function
